...
import static io.github.trojan_gfw.igniter.persistence.TrojanPreferences.KEY_ENABLE_CLASH;
 ...
 * <br/>
 * If you want to interact with the service, you should call {@link #bindService(Intent, ServiceConnection, int)}
